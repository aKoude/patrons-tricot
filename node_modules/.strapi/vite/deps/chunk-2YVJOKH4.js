...
import {
  getStageColorByHex
} from "./chunk-2KRUY7IJ.js";
import {
  LimitsModal
} from "./chunk-H3LSZAIT.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-WZOKCQKA.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-4J4IKDSZ.js";
import {
  index
} from "./chunk-25I553AM.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-42O24JHY.js";
import {
  useConfig
} from "./chunk-BKOG6RC3.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-4GOQZBLL.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-ZNSUZXIW.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-VYF7F5PP.js";
import {
  renderAdmin
} from "./chunk-XPDZ7AJR.js";
import {
  useLicenseLimits
} from "./chunk-QHLTAXB4.js";
import {
  Table,
  useTable
} from "./chunk-IBMBGQUZ.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-EJD2ZXT7.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-EMA3KTZ7.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-WZBTMRON.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-DEFGQCQ3.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-ILSSQCGF.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-B5HJOEB5.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-IPLHIH5G.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-C5GRERXW.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-F4INMRSN.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-E674KCMG.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-AKX6E5GO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-JKN5W5RC.js");
          return {
...
//# sourceMappingURL=chunk-2YVJOKH4.js.map
